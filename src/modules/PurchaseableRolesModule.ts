...
export default class PurchaseableRolesModule extends Module {
  ...
  @command({ inhibitors: [inhibitors.onlySomeRolesCanExecute(["SCIONS OF ELYSIUM", "SENTRIES OF DESCENSUS", "STAFF", "EOS", "ORION"]), inhibitors.userCooldown(600000)], usage: "<user:user>", args: [Arguments.User], group: CommandCategories["Purchasable Role Limitation"], description: commandDescriptions.cancel })
