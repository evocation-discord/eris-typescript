...
export default class PermissionsModule extends Module {
  @command({ inhibitors: [inhibitors.moderatorOnly], group: "Permission Node Negations", args: [new Remainder(String)], aliases: ["na"], staff: true })
  ...
  @command({ inhibitors: [inhibitors.moderatorOnly], group: "Permission Node Negations", args: [new Remainder(String)], aliases: ["nr"], staff: true })
  ...
  @command({ inhibitors: [inhibitors.moderatorOnly], group: "Permission Node Negations", args: [new Remainder(String)], aliases: ["nm"], staff: true })
  ...
  @command({ inhibitors: [inhibitors.moderatorOnly], group: "Permission Node Negations", args: [new Remainder(String)], aliases: ["ne"], staff: true })
